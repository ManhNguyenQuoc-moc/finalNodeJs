...
(function () {
    ...
    function QtyControl () {
      document.querySelectorAll(UomoSelectors.quantityControl).forEach(function($qty) {
        ...
        $reduce.addEventListener('click', function() {
          $number.value = parseInt($number.value) > 1 ? parseInt($number.value) : parseInt($number.value);
        });
  ...
  //   window.location.href='@{/shop-cart/submit}';  // Chuyển hướng tới URL với Thymeleaf
  // });
