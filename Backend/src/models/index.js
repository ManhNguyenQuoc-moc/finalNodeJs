...
if (!Product.schema.virtuals.brand_id) {
  Product.schema.virtual('brand_id')
    .get(function () { return this.brand; })
    .set(function (v) { this.brand = v; });
}
if (!Product.schema.virtuals.category_id) {
  Product.schema.virtual('category_id')
    .get(function () { return this.category; })
    .set(function (v) { this.category = v; });
}
enableVirtuals(Product);

// Review: alias product_id/user_id
if (!Review.schema.virtuals.product_id) {
  Review.schema.virtual('product_id')
    .get(function () { return this.product; })
    .set(function (v) { this.product = v; });
}
if (!Review.schema.virtuals.user_id) {
  Review.schema.virtual('user_id')
    .get(function () { return this.user; })
    .set(function (v) { this.user = v; });
}
...
if (!Order.schema.virtuals.user_id) {
  Order.schema.virtual('user_id')
    .get(function () { return this.user; })
    .set(function (v) { this.user = v; });
}
if (!Order.schema.virtuals.address_id) {
  Order.schema.virtual('address_id')
    .get(function () { return this.address; })
    .set(function (v) { this.address = v; });
}
if (!Order.schema.virtuals.discount_code_id) {
  Order.schema.virtual('discount_code_id')
    .get(function () { return this.discount_code; })
    .set(function (v) { this.discount_code = v; });
}
...
module.exports = {
  ...
  User,
  Wishlist,
  // Address, // nếu bạn require ở trên thì export thêm
};
